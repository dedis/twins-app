import { Button, Icon, IconElement, Layout, StyleService, TopNavigation, TopNavigationAction, useStyleSheet } from '@ui-kitten/components';
...
export const ScanSharesScreen = ({ navigation }) => {
    ...
    return (
        ...
        >
            ...
            {showButton && <Button onPress={onScanNextShare}>Scan Next Share</Button>}
        </Layout>
        </SafeAreaView>
    )
}